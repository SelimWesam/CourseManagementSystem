...
import { getStudents, deleteStudent, createStudent } from '../services/api'
...
export default function StudentsPage() {
  ...
  const handleCreate = async (e) => {
    ...
    try {
      ...
      setFormError(err.response?.data?.title || 'Failed to create student.')
    } finally {
            ...
            <tbody>
              {students.map(student => (
                <tr key={student.id}>
                  ...
                  <td><span className="badge badge-student">{student.role}</span></td>
          ...
          <div className="modal" onClick={e => e.stopPropagation()}>
            ...
            <form onSubmit={handleCreate}>
              <div className="form-group">
                ...
                <input name="fullName" value={form.fullName} onChange={handleChange} required placeholder="e.g. John Smith" />
              </div>
              <div className="form-group">
                <label>Email</label>
                <input type="email" name="email" value={form.email} onChange={handleChange} required placeholder="john@university.com" />
              </div>
              <div className="form-group">
